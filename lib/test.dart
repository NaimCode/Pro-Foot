        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasData) {
            ...
            historiqueList.value.add(HistoriqueModel(
                image: standing.league_v2!.logo,
                name: standing.league_v2!.name));
                  ...
                  child: DataTable(
                      columns: const [
                        ...
                        DataColumn(
                            ...
                            numeric: true),
                        DataColumn(
                            label: ColumnItem(text: "Nuls"), numeric: true),
                        DataColumn(
                            label: ColumnItem(text: "Défaites"), numeric: true),
                        ...
                        DataColumn(
                            label: ColumnItem(text: "Points"), numeric: true),
                        DataColumn(
                            label: ColumnItem(text: "Différence"),
                            numeric: true),
                      ],
                      rows: standing.standing_v1s!
                          .map((e) => DataRow(cells: [
